-- ============================================================
-- MIGRATION 015: USER MANAGEMENT RPC FUNCTIONS
-- Allows frontend to securely perform admin actions via Supabase
-- ============================================================
...
BEGIN
    ...
    IF caller_email != 'rajputnileshsingh3@gmail.com' AND caller_role != 'admin' THEN
    ...
    IF target_role IN ('admin', 'super_admin') AND caller_email != 'rajputnileshsingh3@gmail.com' THEN
